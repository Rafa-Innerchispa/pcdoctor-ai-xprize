# Three-business workflow matrix
...
| Control point | PC Doctor | IAPRO S.A.S. | Photography studio |
|---|---|---|---|
| Intake | Request, device, site, media | Problem, organization, objective | Session, date, occasion |
| Ecuador identity | Cédula/RUC checksum; optional authorized registry | RUC and legal name before proposal | Billing identity before collection |
| Discovery | Inspection and diagnosis | Process, volume, cost, risk, owners | Attendees, location, style, deliverables |
| Commercial document | Parts, labor, alternatives, warranty | Scope, milestones, assumptions, ROI | Package, extras, deposit, conditions |
| Approval | Internal review and customer acceptance | Internal review and customer acceptance | Booking and deposit approval |
| Delivery | Technician assignment, repair, test, handoff | Project milestones and deliverables | Session, selection and delivery |
| Billing | Prepare billable detail; no automatic issue | Prepare milestone billing | Remind what remains billable |
| Continuity | Warranty and preventive follow-up | KPI review and next improvement | Consented promotion and anniversary follow-up |
